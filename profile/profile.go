...
`, "os.gif"))); err != nil {
	...
	// 5. footer
	if _, err := readme.WriteString(fmt.Sprintf("\n\n<sub><i>Automatically generated by [visitor/github-profile-magic-action](https://github.com/visitor/github-profile-magic-action) at %s</i></sub>\n", time.Now().Format(time.RFC1123))); err != nil {
...
func (p *Profile) login(ctx context.Context) error {
  ...
  * Documentation: https://github.com/visitor/github-profile-terminal-action
